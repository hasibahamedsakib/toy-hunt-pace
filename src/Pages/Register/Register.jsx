...
const Register = () => {
  ...
  const { googleLogin, userSignUp, userLogOut } = useContext(AuthContext);
  ...
  const handleRegister = (value) => {
    ...
    setError("");
    userSignUp(value.email, value.password)
      .then((result) => {
        console.log(result);
          ...
          >
            ...
            <div>
              <div className="mb-2 block">
                <Label color="light" htmlFor="username" value="Your Name" />
              </div>
              <TextInput
                sizing="md"
                color="light"
